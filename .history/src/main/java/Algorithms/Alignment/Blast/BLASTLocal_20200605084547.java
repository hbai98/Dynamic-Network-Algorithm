 ...
 * @LastEditTime: 2020-06-05 08:45:43
...
public class BLASTLocal {
    ...
    public void blastp(String queryPath,String subjectPath)throws IOException{
        StringBuffer command = new StringBuffer();
        command.append("cmd /c d: ");
        command.append("&& blastp -subject %s -query YEAST-uniprot-20120518.fasta -out result.out -outfmt \"6 qseqid sseqid evalue\" -num_threads 4");
    }
}
