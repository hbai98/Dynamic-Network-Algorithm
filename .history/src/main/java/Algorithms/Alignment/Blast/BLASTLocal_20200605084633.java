 ...
 * @LastEditTime: 2020-06-05 08:46:33
...
public class BLASTLocal {
    ...
    public void blastp(String queryPath,String subjectPath)throws IOException{
        StringBuffer command = new StringBuffer();
        command.append("cmd /c d: ");
        command.append(String.format(format, args) blastp -subject %s -query %s -out result.out -outfmt \"6 qseqid sseqid evalue\" -num_threads 4");
    }
}
