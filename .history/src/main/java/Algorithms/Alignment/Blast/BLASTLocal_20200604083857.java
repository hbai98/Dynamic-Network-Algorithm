 ...
 * @LastEditTime: 2020-06-04 08:38:53
...
public class BLASTLocal {
    public void createDB(String seqPath, String tgtPath) throws IOException {
        ...
        format("&& makeblastdb -in %s -parse_seqids -blastdb_version 5 -taxid_map test_map.txt -title \"seqDB\" -dbtype prot -out %s",seqPath,tgtPath));
