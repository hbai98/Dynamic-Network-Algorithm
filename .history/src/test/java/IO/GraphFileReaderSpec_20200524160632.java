...
public class GraphFileReaderSpec {
    ...
    protected AdjList readassertNodeNumber(int expected,String filePath) throws IOException {
    ...
    protected AdjList assertEdgeNumber(int expected,String filePath) throws IOException {
        if(reader == null) reader = new GraphFileReader();
        AdjList graph = reader.readToAdjL(filePath);
