 ...
 * @LastEditTime: 2020-05-24 16:47:04
...
public class Human_YeastSub38NTest extends GraphFileReaderSpec {
    ...
    void humanNetworkInput() throws IOException {
        String human9141paht = "src/test/java/resources/TestModule/HGATestData/Human-YeastSub38N/net-38n.txt";
        human9141 = readAndAssertNodeNumber(9141, human9141paht);
