 ...
 * @LastEditTime: 2020-05-24 20:12:00
...
public class Human_YeastSub38NTest extends GraphFileReaderSpec {
    ...
    void readSimilarityMatrix() throws IOException {
        ...
        stopwatch.start();
        simList = readAndAssertNodeNumber(50597, SimPath);
        // reassure it contains nodes for two graphs
        assertEquals(41456, simList.getRowSet().size(), messageSupplier);
