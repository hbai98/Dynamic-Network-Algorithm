 ...
 * @LastEditTime: 2020-06-05 10:02:22
...
public class Human_YeastSub38NTest extends GraphFileReaderSpec {
    ...
    void readSimilarityMatrixFromLocalBlast() throws IOException {
        Table table = Table.read().csv("src\\test\\java\\resources\\TestModule\\HGATestData\\Human-Yeast\\fasta\\resoult.csv");
        HashMap<String,Integer> map = new HashMap<>();
        table.stream().forEach(
            row->{src\test\java\resources\TestModule\HGATestData\Human-Yeast\fasta\result.csv
