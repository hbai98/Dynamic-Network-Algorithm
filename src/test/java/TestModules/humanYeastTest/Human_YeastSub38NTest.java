...
//     */
//    SimList convertSimList(String path) throws IOException {
//        assert(human!=null);
//        assert(yeast!=null);
...
//     */
//    SimList getReadySimList(String path) throws IOException {
//        assert(human!=null);
//        assert(yeast!=null);
//        Table table = Table.read().csv(path);
//        SimList simList = new SimList();
...
//                        simList.sortAddOneNode(yeastNode,humanNode,evalue);
//                    }
//                });
//        // fill the gap
//        HashSet<String> humanGap = human.getAllNodes();
